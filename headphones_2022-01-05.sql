...
VALUES
	('AKG K240',2200,'※阻抗從600歐姆大幅降至55歐姆','assets/img/AKG_K240.jpg','耳罩式','有線','無','','AKG','1','使用Varimotion振膜單體專利技術，降低噪音之餘，展現絕佳錄音與監聽功能'),
	('AKG K701',4990,'※AKG專利設計變向超高精度雙層振膜','assets/img/AKG_K701.jpg','耳罩式','有線','無','','AKG','0','平線發聲線圈技術展現極深頻率延伸，型塑完美音準與優秀結像力'),
	('AKG K702',9200,'※頂級旗艦十大經典名機','assets/img/AKG_K702.jpg','耳罩式','有線','無','','AKG','1','層次分明的精準放音，感受豪華聲場身歷其境'),
	('AKG K712',7890,'※精確有力的聲音效果改進3dB低端性能','assets/img/AKG_K712.jpg','耳罩式','有線','無','','AKG','1','捷克斯洛伐克製造，極高舒適度耳罩設計，音質不與舒適妥協'),
	('Galaxy Buds Pro',6990,'※主動式ANC抗噪及智慧環境音效降噪','assets/img/Galaxy_BudsPro.jpg','入耳式','無線','無','降噪','Samsung','1','品牌耳機魅惑升級，音質功效與硬體質感大幅提升，可隔絕99%噪音'),
	('Galaxy Buds2',4990,'※ANC主動式降噪及智慧通話降噪','assets/img/Galaxy_Buds2.jpg','入耳式','無線','無','降噪','Samsung','1','可愛童趣的耳機造型，附贈前衛簡約的充電盒，提供20小時長效充電'),
	('SONY MDR-XB950N1',7490,'※EXTRA BASS™ 提供深沉有力的低音域效果','assets/img/SONY_MDRXB950N1.jpg','耳罩式','無線','無','降噪','SONY','1','內建全新低頻增強功能，搭配專屬軟體使用，音域效果隨心所欲'),
	('SONY WH-1000XM4',10900,'※具備LDAC功能，高達三倍藍牙資料傳輸量','assets/img/SONY_WH1000XM4.jpg','耳罩式','無線','有','降噪','SONY','1','媲美有線耳機的高穩定性，LDAC打破無線耳機斷訊可能'),
	('SONY WH-H900N',7490,'※支援觸控耳罩面板和快速注意模式','assets/img/SONY_WHH900N.jpg','耳罩式','無線','有','降噪','SONY','1','優於傳統CD的高解析音質，DSEE HX技術還原壓縮損失的精密音域'),
	('SONY WI-SP500',2390,'※開放型驅動單體，方便隨時掌握周遭動靜','assets/img/SONY_WI-SP500.jpg','入耳式','無線','有','運動','SONY','1','專為運動訓練量身打造，儘管掙脫耳機線也能無比牢靠'),
	('SONY WI-SP510',2690,'※EXTRA BASS™ 提供強勁有力的低頻音效','assets/img/SONY_WISP510.jpg','入耳式','無線','無','運動','SONY','1','EXTRA BASS™ 增強音樂節奏感，隨著節拍縱情律動，充飽能量再出發 '),
	('SONY WI-SP600N',4990,'※數位降噪功能，營造零噪音干擾的純粹音效','assets/img/SONY_WI-SP600N.jpg','入耳式','無線','有','運動降噪','SONY','1','系列產品再升級，全新降噪功能，感受與世隔絕的絕美音域'),
	('水月雨 blessing2',11000,'※面蓋採用精密CNC不銹鋼雕刻，表面使用拉絲工藝','assets/img/MoonDrop_Blessing2.jpg','入耳式','有線','無','','水月雨','1','特製全頻複合動鐵單體，有效驅動靈敏低頻，通透還原音質'),
	('水月雨 KATO',5680,'※輕薄質量設計展現更寬廣聲域','assets/img/Moondrop_kato.jpg','入耳式','有線','無','','水月雨','1','耗時兩年打造全新ULT（Ultra-Linear-Technology）超線性動圈單元'),
	('水月雨 kxxs',4980,'※調校至淋漓盡致的淚鑽石鎮模動圈入耳式耳機','assets/img/MoonDrop_KXXS.jpg','入耳式','有線','無','','水月雨','1','內腔體控制氣流更加均衡，降低齒音並提升振膜功效，突破系列窠臼'),
	('水月雨 SSR',1180,'※高強度的液體金屬成型合金腔體','assets/img/MoonDrop_SSR.jpg','入耳式','有線','無','運動','水月雨','1','跳脫市面上重低音的隨波逐流，忠於還原錄音本身音色'),
	('水月雨 光',26800,'※專利聲耦合腔體結構，精確控制諧振頻率','assets/img/MoonDrop_illumination1.jpg','入耳式','有線','無','','水月雨','1','抑制高音的毛刺，消除低頻的駐波，體驗全頻帶的平滑震撼'),
	('鐵三角 ATH-M50xBT2',7600,'※降低影像與聲音間延遲的低延遲模式','assets/img/ATH_M50xBT2.jpg','耳罩式','無線','有','','鐵三角','1','低延遲模式兼顧視聽雙饗宴，功能廣泛支援各品牌語音助理'),
	('鐵三角 HL7BT',5700,'※重量僅220g，展現極致輕巧','assets/img/ATH_HL7BT.jpg','耳罩式','無線','無','','鐵三角','1','與居家空間融為一體的機身塗裝，運用織布材料注入生活質感'),
	('鐵三角 SR50BT',7700,'※內建鋰電池滿電可提供連續28小時播放','assets/img/ATH_SR50BT.jpg','耳罩式','無線','有','','鐵三角','1','配備輕量優化頭帶與機殼旋轉結構，同時兼具音樂雜訊抑制功能'),
	('鐵三角 WS660BT',5200,'※提供約40小時的長效無線播放時間','assets/img/ATH_WS660BT.jpg','耳罩式','無線','無','','鐵三角','1','雙層結構耳墊設計，耳際搭配多功能操作，兼顧舒適與實用性能');
