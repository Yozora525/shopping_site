...
<body>
    ...
    <div class="address">
        <form action="">
            <table>
                <tr>
                    <td class="addressCol">收件地址</td>
                    <td class="postalCodeCol">
                        <input class="postalCode" type="text" name="postalCode" placeholder="請輸入郵遞區號" value="123" readonly/></td>
                    <td class="cityCol">
                        <input type="text" class="city" value="桃園市" readonly>
                    </td>
                    <td class="detailedAddressCol">
                        <input class="detailedAddress" type="text" name="detailedAddress" placeholder="請輸入詳細地址" value="中壢區" readonly>
                    </td>
                </tr>
            </table>
